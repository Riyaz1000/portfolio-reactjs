...
const ProfilePage = () => {
  const BlogPost = Data.map((post) => {
    return (
      <div
        className="bg-[#e7d2c6] text-black pb-24 pt-24 "
        key={post.person.id}
      >
        <div className="flex">
          <div className="ml-[280px] p-10 ">
            <h1 className="text-[#0e7490]  text-xl font-Viga font-bold mb-4">
              Helo, there
            </h1>
            <p className="font-viga font-bold text-5xl mb-5  ">
              I'm <span className="text-orange-800">{post.person.name}</span>{" "}
            </p>
            <p className="text-xl font-Viga font-semibold text-zinc-900">
              A{" "}
              <span className="text-green-900 text-xl font-Viga font-semibold">
                Creative Designer
              </span>{" "}
              and{" "}
              <span className="text-xl font-Viga font-semibold">Developer</span>
            </p>
          ...
          <div>
            <img
              src="https://i.pinimg.com/736x/06/48/85/064885c7cc33aa7ed96a95edaa1c6d1e.jpg"
              alt=""
              className="w-[200px] h-[300px] ml-24"
            />
          </div>
        </div>
      </div>
